...
public class ScratchCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myGLSurfaceView = findViewById(R.id.mgl_scratch_card_render);
        ...
        Bitmap b1 = loadRGBAImage(R.mipmap.img_2380);
        myGLSurfaceView.setAspectRatio(b1.getWidth(), b1.getHeight());
