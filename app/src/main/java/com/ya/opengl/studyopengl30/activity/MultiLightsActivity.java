...
public class MultiLightsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_lights);

        myGLSurfaceView = findViewById(R.id.mgl_multi_lights_render);
