...
import static com.ya.opengl.studyopengl30.MyGLSurfaceView.*;
...
public class TransformFeedbackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transform_feedback);

        myGLSurfaceView = findViewById(R.id.mgl_transform_feedback_render);

        glRender = new GLRender();
        glRender.init();
        glRender.setParamsInt(SAMPLE_TYPE, SAMPLE_TYPE_TRANS_FEEDBACK, 0);
