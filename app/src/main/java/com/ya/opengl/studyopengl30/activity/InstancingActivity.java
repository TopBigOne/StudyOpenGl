...
import static com.ya.opengl.studyopengl30.render.NativeRender.SAMPLE_TYPE_INSTANCING;
 ...
 * 实例化
 */
public class InstancingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instancing);


        myGLSurfaceView = findViewById(R.id.mgl_instancing_render);

        glRender = new GLRender();
        glRender.init();

        glRender.setParamsInt(SAMPLE_TYPE, SAMPLE_TYPE_INSTANCING, 0);
