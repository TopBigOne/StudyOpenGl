...
import static com.ya.opengl.studyopengl30.render.NativeRender.SAMPLE_TYPE_KEY_FBO_BLIT;
import static com.ya.opengl.studyopengl30.render.NativeRender.SAMPLE_TYPE_KEY_MRT;
...
public class FboBlitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fbo_blit);

        myGLSurfaceView = findViewById(R.id.mgl_fbo_blit_render);

        glRender = new GLRender();
        glRender.init();

        glRender.setParamsInt(SAMPLE_TYPE, SAMPLE_TYPE_KEY_FBO_BLIT, 0);

        myGLSurfaceView.setNativeRender(glRender.getNativeRender());
        Bitmap b4 = loadRGBAImage(R.mipmap.lye);
        myGLSurfaceView.setAspectRatio(b4.getWidth(), b4.getHeight());
