...
public class FBOLegLengthenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fboleg_lengthen);

        myGLSurfaceView = findViewById(R.id.mgl_fbo_leg_render);
        ...
        Bitmap b4 = loadRGBAImage(R.mipmap.leg);
