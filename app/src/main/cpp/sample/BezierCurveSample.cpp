 ...
 * */
void
BezierCurveSample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
...
void
BezierCurveSample::UpdateTransformMatrix(float rotateX, float rotateY, float scaleX,
                                         float scaleY) {
