...
void BasicLightingSample::LoadImage(NativeImage *pImage) {
    LOGCATI("BasicLightingSample::LoadImage pImage = %p", pImage->ppPlane[0]);
    if (pImage) {
...
void BasicLightingSample::Draw(int screenW, int screenH) {
    ...
    LOGCATI("BasicLightingSample::Draw()");
...
BasicLightingSample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGCATI("BasicLightingSample::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX,angleY, ratio);
