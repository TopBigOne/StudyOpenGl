...
#ifndef STUDYOPENGL3_0_DEPTHTESTINGSAMPLE_H
#define STUDYOPENGL3_0_DEPTHTESTINGSAMPLE_H
...
public:
    ...
    void UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float scaleY);
...
#endif //STUDYOPENGL3_0_DEPTHTESTINGSAMPLE_H
