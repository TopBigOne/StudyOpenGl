...
#ifndef STUDYOPENGL3_0_STENCILTESTINGSAMPLE_H
#define STUDYOPENGL3_0_STENCILTESTINGSAMPLE_H
...
public:
    ...
    void UpdateMatrix(glm::mat4 &mvpMatrix,
...
#endif //STUDYOPENGL3_0_STENCILTESTINGSAMPLE_H
